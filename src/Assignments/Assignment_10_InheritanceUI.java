...
public class Assignment_10_InheritanceUI extends JFrame{
    ...
    private static void showClockUI(){
     JFrame myFrame = new JFrame("Test GUI");
        ...
        JLabel myText = new JLabel("Current EST time is: " + currentTime("-4"));
        myText.setBounds(300, 500, 500, 200);
        JLabel nyTime = new JLabel("Current New York time is: " + currentTime("America/New_York"));
        nyTime.setBounds(300, 400, 500, 200);
        JLabel mcTime = new JLabel("Current Mexic City time is: " + currentTime("America/Mexico_City"));
        mcTime.setBounds(300, 300, 500, 200);
        JLabel tTime = new JLabel("Current Tokyo time is: " + currentTime("Asia/Tokyo"));
